...
import com.LetsChatBE.dao.FriendDao;
...
public class FriendDaoImpl implements FriendDao{
	...
	private SessionFactory sessionFactory;
	 public List<Users> listOfSuggestedUsers(String username){
		 ...
		 SQLQuery sqlQuery= session.createSQLQuery("select * from A_users where username in (select username from A_users where username!=? minus (select fromid from A_friend where toId=? union select toId from A_friend where fromId=? ))");
